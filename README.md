...
The entire analysis pipeline from data cleaning and transformation (using dplyr) to visualization (using ggplot2) was conducted in R.

*Reproducibility:* The analysis is fully detailed in the Rental\_Affordability\_Report.Rmd file.

###### **View the Full Report**

The complete, knitted HTML report, including all code, methodology, and the final visualization, is available [HERE](https://github.com/FatyaB/housing-affordability-analysis/blob/main/rent_affordability.html).

###### **Repository Contents**

Rental\_Affordability\_Report.Rmd: The complete R Markdown source file.

Rental\_Affordability\_Report.html: The final knitted report document (Recommended viewing).
